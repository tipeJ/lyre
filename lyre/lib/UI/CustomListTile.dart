...
class CustomListTileTheme extends InheritedWidget {
  ...
  static CustomListTileTheme of(BuildContext context) {
    final CustomListTileTheme result = context.inheritFromWidgetOfExactType(CustomListTileTheme);
...
class CustomListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const EdgeInsets _defaultContentPadding = EdgeInsets.symmetric(horizontal: 0.0);
...
class _CustomListTileElement extends RenderObjectElement {
  ...
  final Map<Element, _CustomListTileSlot> childToSlot = <Element, _CustomListTileSlot>{};
...
class _RenderCustomListTile extends RenderBox {
  ...
  final Map<_CustomListTileSlot, RenderBox> slotToChild = <_CustomListTileSlot, RenderBox>{};
  final Map<RenderBox, _CustomListTileSlot> childToSlot = <RenderBox, _CustomListTileSlot>{};
